...
def add_member():
    ...
    reulst=jackson_family.add_member({"first_name":first_name,"age":age,"lucky_numbers":lucky_numbers})
    # this is how you can use the Family datastructure by calling its methods
...
def del_member(member_id):
    ...
    reulst=jackson_family.delete_member(member_id)
    # this is how you can use the Family datastructure by calling its methods
...
def get_single_member(member_id):
    reulst=jackson_family.get_member(member_id)
    # this is how you can use the Family datastructure by calling its methods
